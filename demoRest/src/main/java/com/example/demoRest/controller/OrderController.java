...
import com.example.demoRest.exceptions.OrderNotFoundException;
import com.example.demoRest.payroll.Order;
import com.example.demoRest.payroll.OrderModelAssembler;
import com.example.demoRest.payroll.OrderRepository;
import com.example.demoRest.payroll.Status;
...
public class OrderController {
    ...
    public ResponseEntity<RepresentationModel> cancel(@PathVariable Long id) {
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
                .body(new VndErrors.VndError("Method not allowed", "You can't cancel" +
                        "an order that is in the " + order.getStatus() + " status"));
    }
